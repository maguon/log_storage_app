...
const RecordForCarInfo = props => {
    const { recordForCarInfoReducer: { data: { recordList} } } = props
    return (
        <View style={{ flex: 1 }}>
            <ListHeader />
            <FlatList
...
const mapStateToProps = (state) => {
    return {
        recordForCarInfoReducer: state.recordForCarInfoReducer
    }
}
...
export default connect(mapStateToProps, mapDispatchToProps)(RecordForCarInfo)
